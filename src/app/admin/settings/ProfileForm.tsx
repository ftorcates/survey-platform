  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            <img 
              ...
              alt="Profile" 
              style={{ width: '80px', height: '80px', borderRadius: '50%', border: '4px solid var(--color-surface-hover)' }}
            />
            <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.75rem 1rem', backgroundColor: 'var(--color-surface-hover)', borderRadius: 'var(--radius-md)', color: 'var(--color-text-muted)', fontSize: '0.875rem' }}>
      ...
      <div className="glass-panel" style={{ padding: '2rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem', backgroundColor: 'rgba(79, 138, 139, 0.05)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)' }}>
